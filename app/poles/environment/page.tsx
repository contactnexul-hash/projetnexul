...
export default function EnvironmentPage() {
  const [actions, setActions] = useState([
    { id: 1, title: "Action 1", description: "Description détaillée de l'action 1 pour Environment", validated: false, nxl: 10 },
    { id: 2, title: "Action 2", description: "Description détaillée de l'action 2 pour Environment", validated: false, nxl: 15 },
    { id: 3, title: "Action 3", description: "Description détaillée de l'action 3 pour Environment", validated: false, nxl: 20 },
  ]);
  ...
  return (
    ...
    <CryptoLive />
        <section>
          <h1 className="text-4xl font-bold mb-4">Environment</h1>
          <p className="text-lg text-gray-700">
            Description détaillée du pôle Environment. Ici tu peux expliquer la mission, les objectifs, et les actions clés du pôle.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            Chaque action validée contribue à l'avancement et à la mission globale du pôle Environment. Les NXL gagnés servent à débloquer des fonctionnalités et montrer ton engagement au sein de Nexul.
          </p>
        </section>
      </main>
    </>
