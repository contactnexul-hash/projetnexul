...
export default function ImpactPage() {
  const [actions, setActions] = useState([
    { id: 1, title: "Action 1", description: "Description détaillée de l'action 1 pour Impact", validated: false, nxl: 10 },
    { id: 2, title: "Action 2", description: "Description détaillée de l'action 2 pour Impact", validated: false, nxl: 15 },
    { id: 3, title: "Action 3", description: "Description détaillée de l'action 3 pour Impact", validated: false, nxl: 20 },
  ]);
    ...
    <CryptoLive />
        <section>
          ...
          <p className="text-lg text-gray-700">
            Description détaillée du pôle Impact. Ici tu peux expliquer la mission, les objectifs, et les actions clés du pôle.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-700">
            Chaque action validée contribue à l'avancement et à la mission globale du pôle Impact. Les NXL gagnés servent à débloquer des fonctionnalités et montrer ton engagement au sein de Nexul.
          </p>
        </section>
      </main>
    </>
